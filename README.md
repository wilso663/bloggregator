...
To run this project, you’ll need PostgreSQL installed and running on your machine, as well as a working installation of Go (version 1.25.1 or later). Make sure your PATH is configured so the go command is available in your terminal.
...
You can run the program with commands with the gator <command> <args>
...
follow "feed_url" - add feed results from a browsed feed to get posts when paired with the agg command  
following - "shows the current feed follows for the current user  
